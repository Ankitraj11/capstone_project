...
public class ComplexObjectClass implements Cloneable {
	...
	private int remoteSensorData07;
	...
	public ComplexObjectClass(int remoteSensorData01, int remoteSensorData02, int remoteSensorData03,
			int remoteSensorData04, int remoteSensorData05, int remoteSensorData06, int remoteSensorData07,
			long geoLocationCoordinates01, long geoLocationCoordinates02, long geoLocationCoordinates03,
			long geoLocationCoordinates04) {
		super();
		...
		this.remoteSensorData07 = remoteSensorData07;
	...
	public String toString() {
		return "ComplexObjectClass [remoteSensorData01=" + remoteSensorData01 + ", remoteSensorData02="
				...
				+ remoteSensorData06 + ", remoteSensorData07=" + remoteSensorData07 + ", geoLocationCoordinates01="
				+ geoLocationCoordinates01 + ", geoLocationCoordinates02=" + geoLocationCoordinates02
				+ ", geoLocationCoordinates03=" + geoLocationCoordinates03 + ", geoLocationCoordinates04="
				+ geoLocationCoordinates04 + "]";
	}
	...
	public int getRemoteSensorData07() {
		return remoteSensorData07;
	}
	public void setRemoteSensorData07(int remoteSensorData07) {
		this.remoteSensorData07 = remoteSensorData07;
	}
